<?php 
	...
	class RefeicoesDAO{
        ...
        function addAlimentoRef($idRef, $idAlim, $gramas){
            try {
                $instance = DatabaseConnection::getInstance();
                $conn = $instance->getConnection();
                ...
                $statement->bindValue(":idRef", $idRef);
                $statement->bindValue(":idAlim", $idAlim);
                $statement->bindValue(":gramas", $gramas);
        ...
        function removeAlimentoRef($idRef, $idAlim){
            try {
        ...
        function getRefeicaoApi($idRef, $alimentosList){
            try{
                $instance = DatabaseConnection::getInstance();
                $conn = $instance->getConnection();
